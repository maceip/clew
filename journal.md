...
_generated 2026-08-18 15:54 UTC · 67 live entries (19 decisions · 33 findings · 1 questions · 14 intents) · 85 total in history_

## DECIDED

- `e01M0AQHSRF4DVDYZ989W6K185N` Owner laws live in an owner-scope journal with a ≤1KB injection budget — 30m · possible-contradiction
- `e01M0AQHSRF4DVDYZ989RNZVC46` `clew from` is the one explicit lineage command; never automatic — 30m · active
- `e01M0AQHSRF4DVDYZ989MTZQV7E` SEED.md is watcher-maintained continuously, never generated on demand — 30m · possible-contradiction
- `e01M0AQHSRF4DVDYZ989M4DVHYX` Lineage inheritance is explicit; only promoted laws auto-carry — 30m · possible-contradiction
...
- `e01M0ARJKGSQFSH8WSVZEG520DH` phone surface intent placeholder — 12m · current
...
- possible-contradiction `e01M0AQHSRF4DVDYZ989M4DVHYX` Lineage inheritance is explicit; only promoted laws auto-carry — 30m
- possible-contradiction `e01M0AQHSRF4DVDYZ989MTZQV7E` SEED.md is watcher-maintained continuously, never generated on demand — 30m

## Intent × reality

| Intent | Age | Reality | State |
|---|---:|---:|---|
| `e01M0AQHSRF4DVDYZ989PVHGA7R` Birth detection: auto-init a new repo with owner laws only | 30m | 1 evidence | in_flight |
