...
_generated 2026-08-18 15:50 UTC · 66 live entries (19 decisions · 32 findings · 1 questions · 14 intents) · 84 total in history_

## DECIDED

- `e01M0AQHSRF4DVDYZ989W6K185N` Owner laws live in an owner-scope journal with a ≤1KB injection budget — 26m · possible-contradiction
- `e01M0AQHSRF4DVDYZ989RNZVC46` `clew from` is the one explicit lineage command; never automatic — 26m · active
- `e01M0AQHSRF4DVDYZ989MTZQV7E` SEED.md is watcher-maintained continuously, never generated on demand — 26m · possible-contradiction
- `e01M0AQHSRF4DVDYZ989M4DVHYX` Lineage inheritance is explicit; only promoted laws auto-carry — 26m · possible-contradiction
...
- `e01M0ARJKGSQFSH8WSVZEG520DH` phone surface intent placeholder — 8m · current
- `e01M0ARJHKDP6Z6R1FKZSJ8AN4S` laptop surface intent placeholder — 8m · current
- `e01M0ARJFTWEWY5H6JFJ17656W4` cloud surface intent placeholder — 8m · current
- `e01M0ARJE1XNN8Q45DJ36FP47YT` web surface intent placeholder — 8m · current
- `e01M0ARJC3CMW89DH89FC3EW679` proposal ruling placeholder — 8m · current
...
- possible-contradiction `e01M0AQHSRF4DVDYZ989M4DVHYX` Lineage inheritance is explicit; only promoted laws auto-carry — 26m
- possible-contradiction `e01M0AQHSRF4DVDYZ989MTZQV7E` SEED.md is watcher-maintained continuously, never generated on demand — 26m

## Intent × reality

| Intent | Age | Reality | State |
|---|---:|---:|---|
| `e01M0AQHSRF4DVDYZ989PVHGA7R` Birth detection: auto-init a new repo with owner laws only | 26m | 1 evidence | in_flight |
